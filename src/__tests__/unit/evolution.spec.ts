  ...
  describe('visibleNodes function', () => {
    test('should return nodes with tier <= floor(ep/10)', () => {
      const testCases = [
        ...
        { ep: 20, expectedTier: 2, expectedNodeCount: 5 }, // + claws-1, eggs-2, co-op-1
        { ep: 30, expectedTier: 3, expectedNodeCount: 7 }, // + digestion-2, claws-2
        { ep: 40, expectedTier: 4, expectedNodeCount: 8 }, // + arms-1
      ];
